...
class InstrumentInfoModel:
    ...
    def InitInstrumentInfo(self,nInstrNo,strInstrID,strInstrName,strInstrSerial,strInstrDesc,strInstrLocation,strHighConcentID,strMidConcentID,strLowConcentID,nProtocolID,nBaudRate,strPortName,nIsActive):
        self.InstrumentNo = nInstrNo
        self.InstrumentID = strInstrID
