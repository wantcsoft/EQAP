...
class ProtocolMsgFieldInfo:
    ...
    def InitProtocolMsgFieldInfo(self, nProtocolID, nMsgID, nFieldID, strFieldName, strFieldType, nFieldIndex,
                                 nStartPos, nFieldLen, strValueRange, nToBeCleared, nIsFixed, nIsRepeat, nIsUpload):
